...
from firebase_data import fetch_Indian_Breads_items

def display_Indian_Breads_button(ref, session_state):
    egg_items = fetch_Indian_Breads_items(ref)

    if egg_items:
        if st.button("Indian_Breads", use_container_width=200):
